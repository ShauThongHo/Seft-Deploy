...
class OKXRealTimeAnalyzer:
    ...
    def __init__(self):
        ...
        self.max_data_points = 300  # 最大数据点数
    ...
    def get_historical_data(self, symbol: str, interval: str, limit: int = 300) -> pd.DataFrame:
        """获取历史数据初始化"""
        try:
    ...
    def update_chart(self, frame=None):
        ...
        try:
            ...
            # 获取最新的数据段
            plot_data = self.df.tail(300)  # 显示最近300个数据点
    ...
    def start_realtime(self):
        ...
        try:
            ...
            self.big_status_var.set("📊 正在加载历史数据...")
            self.df = self.get_historical_data(symbol, interval, 300)
