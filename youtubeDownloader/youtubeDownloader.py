...
if st.button("Download"):
    ...
    if url:
        if 'radio' in url and 'list' in url:
            ...
            download_playlist_with_ytdlp(url, choice, cookies_file, proxy_url="https://www.a.cpfrx.info/_zh/")
        else:
            file_path = download_individual_with_ytdlp(url, choice, cookies_file, proxy_url="https://www.a.cpfrx.info/_zh/")
