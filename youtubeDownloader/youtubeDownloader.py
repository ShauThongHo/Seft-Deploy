...
if st.button("Download"):
    ...
    if url:
        if 'radio' in url and 'list' in url:
            ...
            download_playlist_with_ytdlp(url, choice, cookies_file, proxy_url="http://175.145.184.253:8080")
        else:
            file_path = download_individual_with_ytdlp(url, choice, cookies_file, proxy_url="http://175.145.184.253:8080")
